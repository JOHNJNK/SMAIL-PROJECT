...
//        load_mail();
    ...
    public void load_mail(){
        ...
        try {
          ...
          Statement s =(Statement) db.mycon().createStatement();//Select * from email where receiver='anishchamaria1@email.com';
    ...
    public void load_mail_sent(){
        ...
        try {
          ...
          th.repaint();
          un=encription.encrpfun(loggedin.getText());//Select * from email where sender='anishchamaria1@email.com';
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(compose, javax.swing.GroupLayout.DEFAULT_SIZE, 89, Short.MAX_VALUE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(loggedin, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        // TODO add your handling code here:
           int index = jTable1.getSelectedRow();//index=0
            TableModel model = jTable1.getModel();
            if(check==0){//INBOX
            expandmail jf = new expandmail();
            String un=loggedin.getText();//un="john"
            String sender = model.getValueAt(index, 0).toString();//obj(anish)->sender="anish"
            String content = model.getValueAt(index, 1).toString();//content="Hi"
            String date = model.getValueAt(index, 2).toString();//date="15-05-2021"
          ...
          if(rs.next()){
              ...
              s.executeUpdate("Update email set status='Read' where sender='"+sender+"' and receiver = '"+un+"' and content='"+content+"' and date='"+date+"';");
              jf.setVisible(true);
              dispose();
          }
         s.close();
